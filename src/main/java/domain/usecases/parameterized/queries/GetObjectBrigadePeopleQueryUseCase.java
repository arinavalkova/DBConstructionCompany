...
public class GetObjectBrigadePeopleQueryUseCase implements ParamUseCase {
    ...
    public GetObjectBrigadePeopleQueryUseCase(DataReceiver dataReceiver, Property<ObservableList<Row>> property) {
    ...
    public Object invoke(Object object) {
        String sql = "SELECT distinct BAM.NAME as BRIGADE_NAME, PAP.NAME AS EMPLOYEE_NAME\n" +
                ...
                "         inner join BRIGADE_AND_EMPL BAE on S.BRIGADE_ID = BAE.BRIGADE_ID\n" +
                "         inner join BRIGADE_AND_MAN BAM on S.BRIGADE_ID = BAM.ID\n" +
                "         inner join PEOPLE_AND_PROF PAP on PAP.ID = BAE.EMPLOYEE_ID\n" +
                "WHERE OBJECT_ID=" + object.toString();
        ResultSet resultSet;
        try {
